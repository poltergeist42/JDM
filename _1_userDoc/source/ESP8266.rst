        ...
        #. Programmer l'ESP depuis l'IDE Arduino
            ...
            :Liens_Web:
                * https://www.fais-le-toi-meme.fr/fr/electronique/tutoriel/programmes-arduino-executes-sur-esp8266-arduino-ide
                    # Page (FR) expliquant comment configurer l'IDE Arduino pour pouvoir
                    # programmer l'ESP
...
**N.B:** Une fois dans la console Python, il faut tapez **'help()'** pour connaitre les opérations 
    ...
    :File_System_(FS):
            ...
            (en '.py' par exemple) qui seront Exécutés / consultés après la fin de séquence de
            démarrage.
...
---------------------------------------
    ...
    L'ESP8266 est une bestiole sympa qui mérite d'être utilisé. Malheuresement MicroPython est trop
